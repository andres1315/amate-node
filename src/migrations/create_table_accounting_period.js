...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.createTable('accounting_period', {
      ...
      open: { type: Sequelize.BOOLEAN, allowNull: false, defaultValue: false },
      userCreated: { type: Sequelize.INTEGER, allowNull: false },
      userOpen: { type: Sequelize.INTEGER, allowNull: true },
      userClose: { type: Sequelize.INTEGER, allowNull: true },
